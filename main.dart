...
class _DraggableContainerState extends State<DraggableContainer> {
  ...
  Widget build(BuildContext context) {
    return Positioned(
      left: 0,
      top: MediaQuery.of(context).size.height - containerHeight,
              ...
              child: SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    primary: Colors.white, // Changed to white
                    onPrimary: Colors.black, // Changed text color
                    shape: RoundedRectangleBorder(
        ...
        body: Container(
          ...
          child: Stack(
            children: [
              ...
              Positioned(
                left: 17,
                bottom: 100, // Move the input box to the bottom
                child: Container(
                  width: 325,
                  height: 456,
                  decoration: ShapeDecoration(
          ...
          children: [
            ...
            Positioned(
              ...
              child: SizedBox(
                width: 100,
                height: 40,
                child: ElevatedButton( // Changed RaisedButton to ElevatedButton
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => HomePage()),
      ...
      body: Container(
        ...
        child: Center(
          child: Column(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              SizedBox(height: 50), // Added SizedBox to bring down the text
              Text(
                'EDIT PROFILE',
                style: TextStyle(
                  color: Colors.white,
            ...
            children: [
              ...
              Positioned(
                ...
                child: Container(
                  ...
                  height: screenSize.height * 0.456,
                  decoration: ShapeDecoration(
                    color: Color(0xFFD9D9D9),
                    shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(21),
